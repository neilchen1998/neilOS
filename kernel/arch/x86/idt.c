...
struct registers* interrupt_handler(struct registers *regs)
{
    switch (regs->int_no)
    {
        ...
        case 1:
            terminal_write("EXCEPTION: DEBUG\n");
            break;

        case 2:
            terminal_write("EXCEPTION: NMI\n");
            break;
        ...
        case 4:
            terminal_write("EXCEPTION: OVERFLOW\n");
            break;

        case 5:
            terminal_write("EXCEPTION: BOUND RANGE EXCEEDED\n");
            break;
        ...
        case 7:
            terminal_write("EXCEPTION: DEVICE NOT AVAILABLE\n");
            break;

        case 8:
            terminal_write("EXCEPTION: DOUBLE FAULT\n");
            break;

        case 9:
            terminal_write("EXCEPTION: COPROCESSOR SEGMENT OVERRUN\n");
            break;

        case 10:
            terminal_write("EXCEPTION: INVALID TSS\n");
            break;

        case 11:
            terminal_write("EXCEPTION: SEGMENT NOT PRESENT\n");
            break;

        case 12:
            terminal_write("EXCEPTION: STACK-SEGMENT FAULT\n");
            break;
        ...
        case 14:
            terminal_write("EXCEPTION: PAGE FAULT\n");
            break;

        case 16:
            terminal_write("EXCEPTION: x87 FLOATING-POINT\n");
            break;

        case 17:
            terminal_write("EXCEPTION: ALIGNMENT CHECK\n");
            break;

        case 18:
            terminal_write("EXCEPTION: MACHINE CHECK\n");
            break;

        case 19:
            terminal_write("EXCEPTION: SIMD FLOATING-POINT\n");
            break;

        case 20:
            terminal_write("EXCEPTION: VIRTUALIZATION\n");
            break;

        case 21:
            terminal_write("EXCEPTION: CONTROL PROTECTION\n");
            break;

        case 28:
            terminal_write("EXCEPTION: HYPERVISOR INJECTION\n");
            break;

        case 29:
            terminal_write("EXCEPTION: VMM COMMUNICATION\n");
            break;

        case 30:
            terminal_write("EXCEPTION: SECURITY\n");
            break;
